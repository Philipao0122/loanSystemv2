...
if (!SUPABASE_URL || !SUPABASE_KEY) {
  console.error('Error: Faltan las credenciales de Supabase. Verifica tu archivo .env');
...
// Usar el cliente global si está disponible, de lo contrario crear uno nuevo
